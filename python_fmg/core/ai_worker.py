...
class OllamaPromptWorker(QThread):
    ...
    def __init__(self, prompt, db_path="lore_forge_world.db", system_instruction=None, model="qwen2.5:latest", genre="Fantasy"):
        ...
        self.system_instruction = system_instruction or (
            ...
            "Your role is to organize their thoughts, audit their lore for contradictions, and help them narrow down details.\n\n"
            "CRITICAL INTERVIEW CONSTRAINT:\n"
            "- Never dump a long list or bullet points of questions.\n"
            "- Ask EXACTLY ONE or TWO highly focused, specific questions at a time based on what the user is currently focused on.\n"
            "- Keep your tone conversational, concise, and direct.\n\n"
            "When the user is defining a new entity (like a Species, Culture, or Faction), look at the 'Active Templates' list. "
            "Prompt them to provide the specific subheadings required by that template category one by one. Do not invent the answers; ask them probing questions to help them fill it out.\n\n"
