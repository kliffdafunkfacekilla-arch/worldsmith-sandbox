        ...
        if False:
            ...
            for attempt, delay in enumerate(backoff_delays):
                try:
                    ...
                    if he.code == 429:
                        print("Gemini API quota exceeded. Falling back to local Ollama.")
                        LordsmithAIClient.api_exhausted = True
                        break # Skip remaining retries immediately
                except Exception:
                    pass
...
"""
        ...
        for idx, file_path in enumerate(self.file_paths):
            ...
            try:
                ...
                # Process chunks based on Markdown Headers (#, ##, etc.)
                raw_chunks = re.split(r'(?m)^(?=#{1,6}\s+)', raw_prose)
                chunks = []
                            ...
                            if mode == "category":
                                ...
                                if m:
                                    ...
                                    if e_type == "faction":
                                        ...
                                        cursor.execute("INSERT INTO actors (name) VALUES (?)", (e_name,))
